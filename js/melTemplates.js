...
const insertTemplates = () => {
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-3 px-4 py-1 text-end" style="display:block;" id="loginBtnMainContainer">
            <button type="button" class="btn btn-outline-light me-2 mt-2" style="font-size: 0.7rem;" data-bs-toggle="modal" data-bs-target="#modalLogin" id="loginBtnMain">Login</button>
            <button type="button" class="btn btn-primary me-2 mt-2" style="font-size: 0.7rem;" data-bs-toggle="modal" data-bs-target="#modalSignUp" id="signUpBtnMain">Sign-Up</button>
        </div>
        <div class="col-md-3 px-4 py-1 text-end mt-2" style="display:none;" id="logoutBtnMainContainer">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
            <div class="navbar-nav mx-auto">
                ...
                <div class="nav-item dropdown" id="navDropdown">
                    <a href="#" class="nav-item nav-link dropdown-toggle text-dark mainNav" data-toggle="dropdown">Courses</a>
                ...
                <a href="dashboard.html" class="nav-item nav-link text-dark mainNav" style="display:none;" id="dashBtnMain">Dashboard</a>
                <a href="Contact.html" class="nav-item nav-link text-dark mainNav">Contact</a>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content rounded-4 shadow">
          ...
          <div class="modal-body p-5 pt-0">
            <form class="" id="signUpBtn">
              <div class="form-group">
                <select id="signUpRole" class="form-control rounded-3"  style="height: 3.5rem;" required>
              ...
              <div class="form-floating mb-3 col-sm-6">
                <input type="text" class="form-control rounded-3" id="firstName" placeholder="Juan" required>
                <label for="firstName" class="ps-4">First Name</label>
              </div>
              <div class="form-floating mb-3 col-sm-6">
                <input type="text" class="form-control rounded-3" id="lastName" placeholder="Dela Cruz" required>
              ...
              <div class="form-floating mb-3">
                <input type="password" class="form-control rounded-3" id="signUpPassword" placeholder="Password" minlength="8">
                <p id="passwordCheck" class="text-danger"></p>
                <label for="signUpPassword">Password</label>
              </div>
              <div class="form-floating mb-3">
                <input type="password" class="form-control rounded-3" id="confirmPassword" placeholder="confirmPassword" required>
                <p id="confirmPasswordCheck" class="text-danger"></p>
...
// Change current page Main Nav to active
const mainNav = document.getElementsByClassName('mainNav');
const home = mainNav[0].classList;
const about = mainNav[1].classList;
const courses = mainNav[2].classList;
